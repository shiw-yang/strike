...
func GenerateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by github.com/shiw-yang/strike/cmd/protoc-gen-gin. DO NOT EDIT.")
	g.P("// versions:")
	g.P("// - protoc-gen-gin ", release)
	g.P("// - protoc         ", protocVersion(gen))
	g.P("// source: ", file.Desc.Path())
	g.P("package ", file.GoPackageName)
	g.P()
	g.P("// This is a compile-time assertion to ensure that this generated file")
	g.P("// is compatible with the github.com/shiw-yang/strike/cmd/protoc-gen-gin package it is being compiled against.")
